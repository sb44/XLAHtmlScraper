...
using XLAHtmlScraper.UPDATE;

namespace XLAHtmlScraper {
    // Cette classe contient logique de présentation.
    public partial class ThisAddIn {
        public static string NameOfAddin = "XLAHtmlScraper";
        ...
        //private int ctPaneWidth = 780; //+20 de xaml
        //private int ctPaneHeight = 525; //+45 de xaml
        private int ctPaneWidth = 1300; 
        private int ctPaneHeight = 725;
        ...
        private void initSkyNetTP() {
            ...
            myCustomTaskPaneSkyNet = this.CustomTaskPanes.Add(myUserControlFromFM, "Dom Scraping");
        ...
        private void ThisAddIn_Shutdown(object sender, System.EventArgs e) {
            ...
            RegistryKey registryKey = Registry.CurrentUser.OpenSubKey("Software\\Microsoft\\Office\\Excel\\Addins\\XLAHtmlScraper", true);
