...
namespace XLAHtmlScraper.UPDATE {
    public class UpdateManager {

        private readonly string _ftpPath = "waws-prod-sn1-065.ftp.azurewebsites.windows.net";
        private readonly string _ftpfullpath = "ftp://" + "waws-prod-sn1-065.ftp.azurewebsites.windows.net" + "/XLAHtmlScraper.vsto";         // ftp://waws-prod-sn1-065.ftp.azurewebsites.windows.net
        private readonly string _ftpPW = "T4flAygiZ6SST3vnltKf67T2qNY21g7pgygsFDdJbyq3xjx2tabFgPZwCnM3";
        private readonly string _ftpLogin = @"XLAHtmlScraper\$XLAHtmlScraper";
